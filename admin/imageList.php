...
function displayImages(){
   global $database;
   $q = "SELECT id, name, tipo, ruta, descripcion FROM media";
   ...
   echo '<table>';
   echo "<tr><th>Nombre</th><th>descripción</th><th>Im&aacute;gen</th><th>Borrar</th></tr>\n";
   for($i=0; $i<$num_rows; $i++){
   	$id = mysql_result($result, $i, "id");
      $nombre  = mysql_result($result,$i,"name");
	  $descripcion = mysql_result($result, $i, "descripcion");
      $descripcion = strip_tags($descripcion, $allowable_tags = null);
      $tipo = mysql_result($result,$i,"tipo");
      $imagen  = mysql_result($result,$i,"ruta");    
   ...
   echo "<td><a href='../imageList.php?id=$id' target='_blank'>$nombre</a></td><td>$descripcion</td><td><img width='100' height='100' id='$id' src='".$imagen."' ></td><td><img class='delete' style='cursor:pointer;' id='$id' src='/images/close_delete_2.png'></td>";
	echo "</tr>\n";   
   }
   echo "</table><br>\n";
}
...
$(document).ready(function(){
	$(".delete").click(function(){
		var id = $(this).attr("id");
		if(confirm('¿Seguro quieres borrar la imágen?'))
		{
			$.post("/admin/deleteImage.php", { id: id }, function(data){
	...
	<div id="cols" class="box">
		...
		<div id="aside" class="box">
			...
			<ul class="box">
				...
				<li  id="submenu-active"><a href="gallery.php">Galer&iacute;a de im&aacute;genes</a></li>
                	<ul>
		...
		<div id="content" class="box">
			...
			<div class="tabs box">
				<ul>
					<li><a href="#tab01"><span>Listado de Im&aacute;genes</span></a></li>
