...
$(document).ready(function(){
	...
	{
		document.getElementById( 'ruta' ).value = fileUrl;
	}
		...
		<div id="content" class="box">
		 ...
		 <!-- /tab01 -->
			...
			<fieldset>
				...
				<table class="nostyle">
					<tr>
						<td style="width:70px;">Nombre Archivo:</td>
						<td><input type="text" size="40" name="" class="input-text" id="txtNom"/></td>
					</tr>
					<tr>
						<td>Selecciona Archivo:</td>						
                        <td><input id="ruta" name="FilePath" type="text" size="60" />
						<input type="button" value="Browse Server" onclick="BrowseServer();" /></td>
					</tr>
					<tr>
						<td class="va-top">Descripción:</td>
						<td><textarea cols="75" rows="7" class="input-text" id="txtDes"></textarea></td>
					</tr>				
					<tr>
						<td colspan="2" class="t-right"><input type="submit" class="input-submit" value="Subir"  id="submitFile"/></td>
					</tr>
				</table>
			</fieldset>
