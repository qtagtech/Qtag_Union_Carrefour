...
function displayUsers(){
   ...
   if(!$result || ($num_rows < 0)){
      echo "Error mostrando información";
      return;
   }
   if($num_rows == 0){
      echo "Tabla de bases de datos vac&iacute;a";
      return;
   }
   /* Display table contents */
   echo "<table align=\"left\" border=\"1\" cellspacing=\"0\" cellpadding=\"3\">\n";
   echo "<tr><td><b>Nombre de Usuario</b></td><td><b>Nivel</b></td><td><b>Email</b></td><td><b>Última vez activo</b></td></tr>\n";
...
function displayBannedUsers(){
   ...
   $num_rows = mysql_numrows($result);
   if(!$result || ($num_rows < 0)){
      echo "Error mostrando informaci&oacute;n";
      return;
   }
   if($num_rows == 0){
      echo "Tabla vacía";
   ...
   /* Display table contents */
   echo "<table align=\"left\" border=\"1\" cellspacing=\"0\" cellpadding=\"3\">\n";
   echo "<tr><td><b>Usuario</b></td><td><b>Tiempo Bloqueado</b></td></tr>\n";
   for($i=0; $i<$num_rows; $i++){
      $uname = mysql_result($result,$i,"username");
      $time  = mysql_result($result,$i,"timestamp");
...
<body>
<h1>Centro de Administraci&oacute;n : Administraci&oacute;n de usuarios</h1>
<font size="5" color="#ff0000">
<b>::::::::::::::::::::::::::::::::::::::::::::</b></font>
<font size="4">Registrado como: <b><? echo $session->username; ?></b></font><br><br>
Ir a la [<a href="../index.php">P&aacute;gina</a>]<br><br>
<?
if($form->num_errors > 0){
   echo "<font size=\"4\" color=\"#ff0000\">"
       ."!*** Error en la petici&oacute;n, por favor rev&iacute;sela</font><br><br>";
}
?>
 ...
 */
?>
<h3>Usuarios Registrados en el sindicato:</h3>
<?
displayUsers();
?>
</td></tr>
 ...
 */
?>
<h3>Modificar privilegios de un usuario</h3>
...
<option value="1">Usuario Com&uacute;n
