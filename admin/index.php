...
<div id="main">
	...
	<div id="menu" class="box">
		...
		<ul class="box">
            ...
            <li><a href="articles.php"><span>Administraci&oacute;n de Noticias</span></a></li>
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
			...
			<div class="tabs box">
				<ul>
					<li><a href="#tab01"><span>Listado de Afiliados (<?php echo countUsers(); ?>)</span></a></li>
					<li><a href="#tab02"><span>Bloquear Usuarios</span></a></li>
					<li><a href="#tab03"><span>Borrar Usuarios Bloqueados</span></a></li>
					
				</ul>
				<span style="display:block;float:left;clear:none;"><img style="cursor:pointer;" id="csvExport" src="../images/excel.png" alt="Exportar Reporte a Excel" ></span>
				<span style="margin-left: 10px;margin-top:10px;display:block;float:left;clear:none;"><img style="display:none;" id="loading" src="../images/ajax-loader.gif" alt="Generando archivo CSV. Por favor espere." ></span>
			</div> <!-- /tabs -->
			...
			<!-- Tab02 -->
			<div id="tab02">
<p><h3 class="tit">Bloquear un usuario usando el nombre de usuario</h3></p>
				<p><? if($form->error("banuser")): ?><p class="msg warning"><? echo $form->error("banuser"); ?></p><? endif; ?>
...
<p><h3 class="tit">Lista de usuarios bloqueados</h3></p>
<? displayBannedUsers(); ?>
			</div> <!-- /tab02 -->

			<!-- Tab03 -->
			<div id="tab03">
<p><h3 class="tit">Borrar un Usuario bloqueado usando el Nombre de Usuario</h3></p>
				<p><? if($form->error("delbanuser")): ?><p class="msg warning"><? echo $form->error("delbanuser"); ?></p><? endif; ?>
<form action="adminprocess.php" method="POST">
Nombre de Usuario:<br>
