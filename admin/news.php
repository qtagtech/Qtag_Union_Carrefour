...
<div id="main">
	...
	<div id="cols" class="box">
		...
		<p>
			<br />
			<textarea id="titleEditor" name="newsTitle">&lt;h1&gt;T&iacute;tulo del art&iacute;culo.&lt;/h1&gt;</textarea>
			<textarea id="textEditor" name="newsContent">&lt;p&gt;Escribe aqu&iacute; el contenido del art&iacute;culo.&lt;/p&gt;</textarea>
			
		</p>
		<p>
			<input type="submit" id="submitNews" /><div id="loading" style="display:none;"><img src="/images/ajax-loader.gif" alt="Guardando Artículo. Espere por favor" ></div>
		</p>
	</form>
