...
<script>
	Galleria.loadTheme('galeria/themes/classic/galeria.classic.min.js');
</script>
...
<div id="main">
	...
	<div id="menu" class="box">
		...
		<ul class="box">
			...
			<li><a href="#"><span>Galer&iacute;a de Im&aacute;genes</span></a></li>
	...
	<div id="cols" class="box">
		...
		<div id="aside" class="box">
			...
			<ul class="box">
				...
				<li><a href="#">Galer&iacute;a de im&aacute;genes</a></li>
